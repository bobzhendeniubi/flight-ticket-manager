...
import {
  ...
  PaymentMethod,
  cabinClassSchema,
  holdAmountRuleSchema,
  holdOrderStatusSchema,
  holdOverdueActionSchema,
  holdOwnerTypeSchema,
} from './enums.js';
import { batchPassengerInputSchema } from './orders.js';
import { proofUrlSchema } from './lib/proof-url.js';

const cabinSchema = cabinClassSchema;
const ownerTypeSchema = holdOwnerTypeSchema;
const statusSchema = holdOrderStatusSchema;
const amountRuleSchema = holdAmountRuleSchema;
...
export const updateHoldOrderConfigBodySchema = z.object({
  ...
  overdueAction: holdOverdueActionSchema,
