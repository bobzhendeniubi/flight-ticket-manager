...
export const visaChangeSubmitSchema = z.object({
  toVisaStatus: visaRequirementSchema,
});
...
export const listOrderChangeRequestsQuerySchema = z.object({
  status: orderChangeRequestStatusSchema.optional(),
  kind: orderChangeKindSchema.optional(),
