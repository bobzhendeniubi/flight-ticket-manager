...
export const createVisaBodySchema = z.object({
  ...
  issuanceMethod: visaIssuanceMethodSchema.nullable().optional(),
  entryType: visaEntryTypeSchema.nullable().optional(),
...
export const createBundleBodySchema = z.object({
  ...
  settlementTier: settlementTierSchema.nullable().optional(),
