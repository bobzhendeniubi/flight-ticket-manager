...
import {
  ...
  visaIssuanceMethodSchema,
  visaRequirementSchema,
  visaSubmissionStatusSchema,
} from './enums.js';
...
const statusFilterSchema = z.preprocess(
  ...
  z.array(fulfillmentStatusSchema).min(1).optional(),
);
...
export const listFulfillmentQuerySchema = z.object({
   ...
   */
  visaRequirement: z.union([visaRequirementSchema, z.literal('UNSET')]).optional(),
  /**
   ...
   */
  issuanceMethod: z.union([visaIssuanceMethodSchema, z.literal('NONE')]).optional(),
  /**
...
export const updateVisaPassengerStatusBodySchema = z.object({
  status: visaSubmissionStatusSchema,
});
...
export const batchVisaPassengerStatusBodySchema = z.object({
  ...
  toStatus: visaSubmissionStatusSchema,
});
